...
export default function VisitingScholars() {
  return (
      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-2xl mx-auto mt-6 px-6">
          <p className="text-slate-700 text-base leading-relaxed text-center">
            The Visiting Scholars program will host researchers from academic institutions worldwide for short-term
            collaborative engagements with the Institute — typically one to six months. Visiting Scholars pursue their
            own research agendas while contributing to the Institute's seminars and discussions. Application details
            will be announced; in the meantime, researchers interested in a visit are invited to make contact.
          </p>
        </section>
