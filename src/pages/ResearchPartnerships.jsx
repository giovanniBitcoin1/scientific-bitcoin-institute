      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-2xl mx-auto mt-6 px-6">
          <p className="text-slate-700 text-base leading-relaxed text-center">
            The Scientific Bitcoin Institute pursues formal research partnerships with universities, independent
            research groups, and research-focused organizations whose work intersects with the Institute's mission.
            Partnerships typically involve joint research projects, co-authored publications, shared seminars, or
            longer-term collaborative engagements on specific scientific questions. The Institute is actively
            building this network. Academic and research institutions interested in exploring a partnership are
            invited to contact the Institute.
          </p>
        </section>
