      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-2xl mx-auto mt-8 px-6">
          <p className="text-slate-700 text-base leading-relaxed text-center">
            The Institute is planning workshops on specific research themes — including the methodology of empirical
            Bitcoin analysis, complex-systems modeling, and open problems in Bitcoin science. Details on upcoming
            workshops will be published here.
          </p>
        </section>
        ...
        <section className="max-w-2xl mx-auto px-6 text-center">
          <p className="text-slate-700 text-base leading-relaxed mt-12">
            Subscribe to the Institute's monthly dispatch to be notified when workshops are announced.
          </p>
        </section>
