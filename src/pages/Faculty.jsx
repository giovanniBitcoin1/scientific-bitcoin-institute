      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-2xl mx-auto mt-6 px-6">
          <p className="text-slate-700 text-base leading-relaxed text-center">
            The Scientific Bitcoin Institute is developing its faculty program — researchers in residence at the
            Institute who lead long-term research agendas across the Institute's areas of inquiry. Details on faculty
            positions and the application process will be announced as the program is established. Researchers
            interested in faculty appointments at the Institute are invited to make contact.
          </p>
        </section>
