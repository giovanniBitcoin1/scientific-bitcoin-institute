      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-2xl mx-auto mt-6 px-6">
          <p className="text-slate-700 text-base leading-relaxed text-center">
            The Scientific Bitcoin Institute is developing academic programs in collaboration with universities and
            research institutions worldwide — including jointly-supervised theses and doctoral projects, guest
            lectures by Institute researchers, and integration of Bitcoin science into existing physics, mathematics,
            computer science, and economics curricula. Academic institutions interested in exploring program
            collaboration are invited to make contact.
          </p>
        </section>
