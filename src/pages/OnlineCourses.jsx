      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-2xl mx-auto mt-6 px-6">
          <p className="text-slate-700 text-base leading-relaxed text-center">
            The Institute is developing online courses on Bitcoin science, complex systems, and the Power Law Theory
            — designed for self-directed learners with mathematical or scientific backgrounds. Course material and
        ...
        <section className="max-w-2xl mx-auto px-6 text-center">
          <p className="text-slate-700 text-base leading-relaxed mt-12">
            Subscribe to the Institute's monthly dispatch to be notified when courses are launched.
          </p>
        </section>
