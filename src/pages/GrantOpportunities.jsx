      ...
      <main className="pt-28 pb-24">
        ...
        <section className="max-w-2xl mx-auto mt-6 px-6">
          <p className="text-slate-700 text-base leading-relaxed text-center">
            The Scientific Bitcoin Institute is establishing a grant program to fund external research projects on
            questions in Bitcoin's mathematical, physical, and economic foundations. Grant categories under
            development include short-term research grants for specific open problems, support for graduate student
            research, and travel grants for academic conferences. Application details will be published as the grant
            program is launched. Researchers interested in receiving funding for relevant work are invited to make
